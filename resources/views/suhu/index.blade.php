...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-3 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" action="/suhu/store" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="suhu">Suhu</label>
                            <input type="text" class="form-control" name="suhu" id="suhu" placeholder="Suhu" />
                        </div>
                        <div class="form-group">
                            <label for="kelembapan">Kelembapan</label>
                            <input type="text" class="form-control" name="kelembapan" id="kelembapan" placeholder="Kelembapan" />
                        </div>
