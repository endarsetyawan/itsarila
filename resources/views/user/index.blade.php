                                        ...
                                        @foreach ($user as $data)  
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div>
                                                            <a href="/user/{{ $data->id }}/edit" class="btn btn-primary btn-rounded "><i class="mdi mdi-tooltip-edit btn-icon-prepend"></i></a>
                                                        </div>
                                                        <div>
                                                            <form action="/user/{{ $data->id }}/delete" method="post">
                                                                @method('delete')
                                                                @csrf
